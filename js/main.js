...
function getZodiac() {
  ...
  for (i = 0; i < zodiac.length; i++) {
    if (animal === zodiac[i].animal) {
      document.getElementById("yourAnimal").innerHTML = zodiac[i].animal
      document.getElementById("animalPic").src = zodiac[i].image
      document.getElementById("yourZodiac").innerHTML = zodiac[i].traits
      return
    } else {
      document.getElementById("yourAnimal").innerHTML = "Please enter one of the 12 animals of the zodiac!"
    }
  }
}